...
public class Quicksort extends javax.swing.JFrame {
  ...
  int Arreglo[] = {4, 1, 3, 2, 5};
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Se trata de un método de ordenamiento de intercambio.\nTambién se le conoce como método rápido o método \nde ordenación por partición.\n");
        ...
        getContentPane().add(fondo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 73, -1, -1));
        ...
        getContentPane().add(fondo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 457, -1, 75));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("ORDENAMIENTO QUICKSORT");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 23, 233, 39));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/algortimos_interfaz/fondo2.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 0, 550, 540));
